    ...
    var Controller = {
        ...
        index: function () {
            ea.table.render({
                ...
                cols: [[
                    {width:200, field: 'account.username', title: '提款商户'},
                    {width:200, field: 'bank_name', title: '开户银行', search_ignore:true},
                    {width:150, field: 'bank_account', title: '银行账号', search_ignore:true},
                    {width:150, field: 'bank_owner', title: '开户人'},
                    {width:150, field: 'amount', title: '提款金额', search_ignore:true},
                    {width:115, field: 'withdraw_type', title: '提款类型', search_ignore:true, templet:
                        function (data, option) {         
                            var withdraw_type = ['代理分润', '订单入款']
                            return withdraw_type[data.withdraw_type]
                        },
                    },
                    {width:115, field: 'status', title: '提款状态', search: 'select',

    ...
    var Controller = {
        ...
        index: function () {
            ea.table.render({
                ...
                cols: [[
                    {width:115, field: 'username', title: '商户号'},
                    {width:115, field: 'account_name', title: '商户名称'},
                    {field: 'deposit', title: '商户押款', width: 350, templet:
                    ...
                    {width:115, field: 'is_agent', title: '代理权限', templet:
                        function (data, option) {
                            if (data.is_agent) {
